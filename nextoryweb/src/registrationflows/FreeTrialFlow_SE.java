...
public class FreeTrialFlow_SE extends SuperTestScript{
	...
	@Test(enabled = true,priority = 1, groups = { "FreeTrialFlow_SE" },dataProvider="userData_SE",
	...
	public void FreeTrialFlow_Positive(String subs,String email,String password,String gateway,String CardNumber,String cvc,String month,String year,
		...
		Assert.assertTrue(sub.getTrailDate().trim().contains(AddDate.addingDays(14,"normal").toString().trim()));
		...
		if(gateway.equals("Adyen")) {
			...
			if(subs.equals("Silver")) {
				...
				Assert.assertTrue(pay.getPaymentSummary(2).trim().contains(AddDate.addingDays(14, "normal").toString().trim()));
			}else if(subs.equals("Guld")) {
		...
		Assert.assertTrue(suba.getAccountText().trim().contains(AddDate.addingDays(14,"normal").toString().trim()));
	...
	@Test(enabled = true,priority = 2,groups= {"FreeTrialNegative_SE"})
	...
	@Test(enabled = false,priority = 3,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled = true,priority = 4,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled = true,priority = 5,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled = true,priority = 6,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled=true,priority=7,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled=true,priority=8,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled=true,priority=9,groups = {"FreeTrialNegative_SE"})
	...
	@Test(enabled=true,priority=10,groups= {"FreeTrialNegative_SE"})
	...
	@Test(enabled=true,priority=11,groups= {"FreeTrialNegative_SE"})
	public void FreeTrailFlow_Payment_invalidOtp() {
		...
		boolean result = pay.getTrustlyError_invalidOtp().equals(ExpectedError.trim())||pay.getTrustlyError_invalidOtp().equals("The one-time code was not correct.");
